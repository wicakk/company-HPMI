...
<div class="space-y-5">
    <div class="flex items-center gap-3">
        ...
        <h2 class="text-xl font-bold text-gray-900 dark:text-white">Edit Artikel</h2>
    </div>
            ...
            <div class="lg:col-span-2 space-y-5">
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title', $article->title) }}" required class="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Ringkasan</label>
                        <textarea name="excerpt" rows="3" class="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500">{{ old('excerpt', $article->excerpt) }}</textarea>
                    </div>
                    <div>
                        ...
                        <textarea name="content" rows="16" required class="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500 font-mono">{{ old('content', $article->content) }}</textarea>
                    </div>
                </div>
            </div>
            <div class="space-y-5">
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <select name="status" class="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500">
                            ...
                            <option value="published" {{ $article->status==='published'?'selected':'' }}>Diterbitkan</option>
                            <option value="archived" {{ $article->status==='archived'?'selected':'' }}>Diarsip</option>
                        </select>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="thumbnail" value="{{ old('thumbnail', $article->thumbnail) }}" class="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500">
                    </div>
                </div>
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('admin.articles.index') }}" class="flex-1 py-2.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:bg-gray-200 transition text-center">Batal</a>
                </div>
            </div>
        </div>
    </form>
