...
<div class="space-y-6"
  ...
  <div class="flex items-center gap-3">
    ...
    <div>
      ...
      <p class="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Perbarui detail kegiatan</p>
    </div>
  </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 overflow-hidden">
          ...
          <div class="p-6 space-y-5">
            <div>
              ...
              <input type="text" name="title" value="{{ old('title', $event->title) }}" required placeholder="Nama kegiatan atau acara..."
            ...
            <div>
              ...
              <textarea name="description" rows="5" placeholder="Jelaskan detail kegiatan, tujuan, dan manfaatnya..."
                class="w-full px-4 py-2.5 text-sm border border-slate-200 dark:border-slate-600 rounded-xl bg-slate-50 dark:bg-slate-700/50 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500 dark:focus:ring-violet-400 transition resize-none">{{ old('description', $event->description) }}</textarea>
            </div>
            <div>
              ...
              <textarea name="requirements" rows="3" placeholder="Persyaratan peserta, dokumen yang dibutuhkan..."
                class="w-full px-4 py-2.5 text-sm border border-slate-200 dark:border-slate-600 rounded-xl bg-slate-50 dark:bg-slate-700/50 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500 dark:focus:ring-violet-400 transition resize-none">{{ old('requirements', $event->requirements) }}</textarea>
            </div>
          </div>
        </div>
          ...
          <div class="p-6 space-y-4">
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="datetime-local" name="start_date" value="{{ old('start_date', $event->start_date ? \Carbon\Carbon::parse($event->start_date)->format('Y-m-d\TH:i') : '') }}" required
              ...
              <div>
                ...
                <input type="datetime-local" name="end_date" value="{{ old('end_date', $event->end_date ? \Carbon\Carbon::parse($event->end_date)->format('Y-m-d\TH:i') : '') }}"
                  class="w-full px-4 py-2.5 text-sm border border-slate-200 dark:border-slate-600 rounded-xl bg-slate-50 dark:bg-slate-700/50 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-violet-500 dark:focus:ring-violet-400 transition">
              </div>
            </div>
            <div>
              ...
              <input type="text" name="location" value="{{ old('location', $event->location) }}" placeholder="Gedung X, Jakarta / Online"
                class="w-full px-4 py-2.5 text-sm border border-slate-200 dark:border-slate-600 rounded-xl bg-slate-50 dark:bg-slate-700/50 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500 dark:focus:ring-violet-400 transition">
            </div>
            <div>
              ...
              <input type="url" name="meeting_url" value="{{ old('meeting_url', $event->meeting_url) }}" placeholder="https://zoom.us/j/..."
                class="w-full px-4 py-2.5 text-sm border border-slate-200 dark:border-slate-600 rounded-xl bg-slate-50 dark:bg-slate-700/50 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500 dark:focus:ring-violet-400 transition">
            </div>
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 overflow-hidden">
          ...
          <div class="p-6 space-y-4">
            ...
            <div>
              ...
              <input type="text" name="thumbnail" value="{{ old('thumbnail', $event->thumbnail) }}" placeholder="https://..."
                class="w-full px-4 py-2.5 text-sm border border-slate-200 dark:border-slate-600 rounded-xl bg-slate-50 dark:bg-slate-700/50 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500 dark:focus:ring-violet-400 transition">
            </div>
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 overflow-hidden sticky top-5">
          ...
          <div class="p-5 space-y-4">
            ...
            <div>
              ...
              <input type="number" name="quota" value="{{ old('quota', $event->quota) }}" min="0" placeholder="Kosongkan = tak terbatas"
                class="w-full px-4 py-2.5 text-sm border border-slate-200 dark:border-slate-600 rounded-xl bg-slate-50 dark:bg-slate-700/50 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500 dark:focus:ring-violet-400 transition">
            </div>
            <div>
            ...
            <div class="space-y-2.5 pt-1">
              <label class="flex items-center gap-2.5 text-sm font-medium text-slate-700 dark:text-slate-300 cursor-pointer">
                <input type="checkbox" name="is_free" value="1" {{ old('is_free', $event->is_free)?'checked':'' }} class="w-4 h-4 rounded border-slate-300 dark:border-slate-600 text-emerald-500 focus:ring-emerald-400">
                Gratis
              </label>
              <label class="flex items-center gap-2.5 text-sm font-medium text-slate-700 dark:text-slate-300 cursor-pointer">
                <input type="checkbox" name="is_member_only" value="1" {{ old('is_member_only', $event->is_member_only)?'checked':'' }} class="w-4 h-4 rounded border-slate-300 dark:border-slate-600 text-violet-500 focus:ring-violet-400">
                Khusus Anggota
              </label>
            </div>
          </div>
